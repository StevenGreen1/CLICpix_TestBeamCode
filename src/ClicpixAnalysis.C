...
void ClicpixAnalysis::initial()
{
	...
	hGlobalResidualsXversusX = new TH2F("hGlobalResidualsXversusX","hGlobalResidualsXversusX",50,-1.,1.,600,-0.3,0.3);
	hGlobalResidualsXversusY = new TH2F("hGlobalResidualsXversusY","hGlobalResidualsXversusY",50,0.,2.,600,-0.3,0.3);
	hGlobalResidualsYversusY = new TH2F("hGlobalResidualsYversusY","hGlobalResidualsYversusY",50,0.,2.,600,-0.3,0.3);
	hGlobalResidualsYversusX = new TH2F("hGlobalResidualsYversusX","hGlobalResidualsYversusX",50,-1.,1.,600,-0.3,0.3);
	...
	hClusterSizeAssociated = new TH1F("hClusterSizeAssociated","hClusterSizeAssociated",50,0,50);
	hClusterWidthRowAssociated = new TH1F("hClusterWidthRowAssociated","hClusterWidthRowAssociated",50,0,50);
	hClusterWidthColAssociated = new TH1F("hClusterWidthColAssociated","hClusterWidthColAssociated",50,0,50);

	hClusterTOTAssociated = new TH1F("hClusterTOTAssociated","hClusterTOTAssociated",100,0,100);
	hClusterTOTAssociated1pix = new TH1F("hClusterTOTAssociated1pix","hClusterTOTAssociated1pix",100,0,100);
	hClusterTOTAssociated2pix = new TH1F("hClusterTOTAssociated2pix","hClusterTOTAssociated2pix",100,0,100);
	hClusterTOTAssociated3pix = new TH1F("hClusterTOTAssociated3pix","hClusterTOTAssociated3pix",100,0,100);
	hClusterTOTAssociated4pix = new TH1F("hClusterTOTAssociated4pix","hClusterTOTAssociated4pix",100,0,100);
...
void ClicpixAnalysis::run(TestBeamEvent *event, Clipboard *clipboard)
{
	...
	for (it = tracks->begin(); it != tracks->end(); ++it) {
		...
		if(matched){
			...
			hClusterSizeAssociated->Fill((*itcMatched)->size());
			hClusterWidthColAssociated->Fill((*itcMatched)->colWidth());
			hClusterWidthRowAssociated->Fill((*itcMatched)->rowWidth());
