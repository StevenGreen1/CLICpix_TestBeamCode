...
void ResidualPlotter::initial()
{
  ...
  for (int i = 0; i < summary->nDetectors(); i++) {
    ...
    TH2F* h2 = 0;
    double limit = 0.05;
    //const int nbins = int(200 * limit / 0.05); ==== Original Code - S.Green, 22.9.15
    const int nbins = int(400 * limit / 0.05); // ==== Edited Code to get more precision in alignement - S.Green, 22.9.15
