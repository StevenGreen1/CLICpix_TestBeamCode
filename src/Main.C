...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  // Remove tracks with a chi2/ndof greater than X.  If perfect fit then this should be 1,
  // so at the moment no realy cut is being applied.

  //DEFAULT// par->trackchi2NDOF = 1.e+5 ;

  par->trackchi2NDOF = 1 ; // Applying a cut now, S.Green, 22.9.15
